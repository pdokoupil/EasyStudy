...
!!! note "How to add an entry"
    Keep each entry to the schema below — it's what readers actually scan for. **Recommended per study:**
    a one-line *what was studied*, the *venue + year* with a citation/DOI link, *N participants*, the
    *plugin/branch* used, and **one representative screenshot** (either a screenshot of the deployed study
    UI, or the paper's teaser figure — they're your own figures to reuse). Put images in
    `docs/assets/gallery/<slug>.png` and reference them as shown. Numbers > adjectives.
...
- **Screenshot:** _add `docs/assets/gallery/rows-or-columns.png`_ — e.g. the comparison page in row vs column layout.
...
- **Screenshot:** _add `docs/assets/gallery/multiobjective-sliders.png`_.
...
- **Screenshot:** reuse Figure 2 from the paper (admin form + comparison page).
...
- **Venue:** IEEE (VIS-adjacent) — [ieeexplore 10854212](https://ieeexplore.ieee.org/document/10854212) ·
  and Springer chapter [10.1007/978-3-031-49368-3_14](https://doi.org/10.1007/978-3-031-49368-3_14)
- **Screenshot:** _add `docs/assets/gallery/dataviz.png`_.
...
- **Screenshot:** _add a course/study screenshot, or link the syllabus._

## Papers citing EasyStudy
_Drop the BibTeX/links for papers that used or cited EasyStudy here (you mentioned you can gather these)._
A short bulleted list of "Title — venue, year — [link]" is enough; it doubles as a citation count signal.
